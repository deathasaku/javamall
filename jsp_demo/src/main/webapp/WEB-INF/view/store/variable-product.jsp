...
<title>Lukani - variable product</title>
				...
				<div class="col-lg-6 col-md-6">
					<div class="product_d_right">
						<form action="#">
							...
							<div class="product_nav">
								<ul>
									...
									<li class="next"><a href="product-grouped"><i
							...
							<div class="product_variant size">
								<label>size</label> <select class="select_option" id="color2"
									name="produc_color2">
						...
						<div class="product_d_meta">
							<span>SKU: N/A</span> <span>Category: <a href="#">Clothings</a></span>
							<span>Tags: <a href="#">Creams</a> <a href="#">Lotions</a>
							</span>
						</div>
					...
					<div class="col-lg-3">
						<article class="single_product">
							<figure>
								<div class="product_thumb">
									<a class="primary_img" href="product-details"><img
										src="${ctx}/assets/img/product/product3.jpg" alt=""></a>
									<div class="label_product">
								...
								<figcaption class="product_content">
									...
									<h4 class="product_name">
										<a href="product-details">fringilla augue</a>
									</h4>
									<div class="price_box">
										<span class="current_price">£68.00</span> <span
											class="old_price">£75.00</span>
									</div>
								</figcaption>
							</figure>
						</article>
					...
					<div class="col-lg-3">
						<article class="single_product">
							<figure>
								<div class="product_thumb">
									<a class="primary_img" href="product-details"><img
										src="${ctx}/assets/img/product/product4.jpg" alt=""></a>
									<div class="label_product">
								...
								<figcaption class="product_content">
									...
									<h4 class="product_name">
										<a href="product-details">massa massa</a>
									</h4>
									<div class="price_box">
										<span class="current_price">£75.00</span> <span
											class="old_price">£80.00</span>
									</div>
								</figcaption>
							</figure>
					...
					<div class="col-lg-3">
						<article class="single_product">
							<figure>
								<div class="product_thumb">
									<a class="primary_img" href="product-details"><img
										src="${ctx}/assets/img/product/product5.jpg" alt=""></a>
									<div class="label_product">
								...
								<figcaption class="product_content">
									...
									<h4 class="product_name">
										<a href="product-details">placerat vestibulum</a>
									</h4>
									<div class="price_box">
										<span class="current_price">£65.00</span> <span
											class="old_price">£70.00</span>
					...
					<div class="col-lg-3">
						<article class="single_product">
							<figure>
								<div class="product_thumb">
									<a class="primary_img" href="product-details"><img
										src="${ctx}/assets/img/product/product6.jpg" alt=""></a>
									<div class="label_product">
										<span class="label_sale">-9%</span>
									</div>
									<div class="action_links">
								...
								<figcaption class="product_content">
									...
									<h4 class="product_name">
										<a href="product-details">Porro Cook</a>
									</h4>
									<div class="price_box">
										<span class="current_price">£62.00</span> <span
											class="old_price">£68.00</span>
									</div>
								</figcaption>
							</figure>
						</article>
