...
<head>
    ...
    <title>Lukani - product sidebar</title>
...
<body>
    ...
    <div class="product_details product_sidebar mt-100">
        <div class="container">
            <div class="row">
                                    ...
                                    <article class="single_product">
                                            <figure>
                                                <div class="product_thumb">
                                                    <a class="primary_img" href="product-details"><img src="assets/img/product/product10.jpg" alt=""></a>
                                   ...
                                   <form action="#">
                                        ...
                                        <div class="product_nav">
                                            <ul>
                                                ...
                                                <li class="next"><a href="product-grouped"><i class="fa fa-angle-right"></i></a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <article class="single_product">
                                        <figure>
                                            ...
                                            <figcaption class="product_content">
                                                ...
                                                <h4 class="product_name"><a href="product-details">Porro Cook</a></h4>
                                                <div class="price_box"> 
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="product-details">sapien libero</a></h4>
                                    <div class="price_box"> 
                                        <span class="current_price">£69.00</span>
                                        <span class="old_price">£74.00</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="product-details">vulputate rutrum</a></h4>
                                    <div class="price_box"> 
            ...
            <div class="row">
                <div class="col-12">
                    <div class="brand_container owl-carousel">
                        ...
                        <div class="single_brand">
                            <a href="#"><img src="assets/img/brand/brand6.jpeg" alt=""></a>
                        </div>
                        <div class="single_brand">
