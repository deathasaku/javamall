	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<!-- Content Header (Page header) -->
					<form action="${ctx}/admin/editEmployee" method="post" id="add_goods" role="form" enctype="multipart/form-data"
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group">
										<label>帳號</label> <input type="text" class="form-control" name="account" readonly="readonly"
										value="${em.account}"
											placeholder="Enter ..." id="goodsName" required="required">
                    ...
                    <div class="input-group">
                      ...
                      <div class="help-block with-errors text-danger"
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<label>姓名</label> <input type="text"  class="form-control" required="required" value="${em.username}"
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label>手機</label> <input type="text"  class="form-control" required="required" value="${em.tel}"
											placeholder="Enter ..." id="originalPrice" name="tel">
										<div class="help-block with-errors text-danger"
											style="font-family: Microsoft JhengHei;"></div>
									</div>
								</div>
                        ...
                        <select class="form-control" name="type">
                          <option <c:if test="${em.type=='打雜'}">selected</c:if> >打雜</option>
                          <option <c:if test="${em.type=='經理'}">selected</c:if> >經理</option>
                        </select>
                      </div>
							...
							<div class="row">
																		<div class="form-group">
												<img id="blah" src="${em.image}" width="300" height="300"
													class="d-none" />
											</div>
							</div>
...
<script src="${ctx}/admin/js/adduser.js"></script>	
