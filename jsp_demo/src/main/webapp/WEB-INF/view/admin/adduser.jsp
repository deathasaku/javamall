	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<!-- Content Header (Page header) -->
					<form action="${ctx}/admin/adduser/action" method="post" id="add_goods" role="form" enctype="multipart/form-data"
				data-toggle="validator">
				<!-- Main content -->
				<section class="content">
					<div class="card card-warning">
						<div class="card-header">
							<h3 class="card-title">新增員工帳號</h3>
						</div>
						<!-- /.card-header -->
...
<div class="row">
					...
					<div class="card-footer">
						...
						<button type="button" class="btn btn-primary" onclick="autowrite()">快速填寫</button>
					</div>
